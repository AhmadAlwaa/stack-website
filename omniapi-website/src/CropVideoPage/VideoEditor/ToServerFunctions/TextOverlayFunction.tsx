...
export const TextOverlayFunction =  async(file_id:string, text:string, x_pos:number, y_pos:number, font_size:string,font:string,color:string,location:string, task_id:string) =>{
